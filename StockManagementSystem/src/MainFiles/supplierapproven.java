 ...
 * @author DELL
 */
public class supplierapproven extends javax.swing.JFrame {

    /**
     * Creates new form supplierapproven
     */
    public supplierapproven() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton4.setText("Approve order");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(supplierapproven.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new supplierapproven().setVisible(true);
            }
        });
    }
